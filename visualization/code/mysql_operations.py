...
def write_in(password:str,info:dict):
    ...
    #写入数据
    insert_cmd="INSERT INTO Basic_information (title,link,cover_img_src,post_time,details,tags,views,speaker_name,speaker_img_src,speaker_position,speaker_intro) \
        VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
    for title in info:
        lis=[title]+info[title]
        tp=tuple(lis)
